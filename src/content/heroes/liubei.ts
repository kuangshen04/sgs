...
export function installLiubei(c: Container): void {
  c.skills.define({
    name: '仁德',
    effects: [{
      form: 'activated',
  ...
  c.skills.define({
    ...
    effects: [
      ...
      },
      {
        ...
        ai: {
          shouldUse: () => true,
          priority: c.cards.get(CardType.Sha)!.ai.usePriority,
        },
      },
    ],
  });

  c.heroes.register({ name: '刘备', maxHp: 4, sex: 'male', group: '蜀', isLord: true, skills: ['仁德', '激将'] });
}
