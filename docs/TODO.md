...
- 曹操（奸雄）、刘备（仁德）、关羽（武圣）、赵云（龙胆①）、甘宁（奇袭）、夏侯惇（刚烈）、司马懿（反馈/鬼才）、郭嘉（遗计/天妒）、甄宓（洛神/倾国）、张辽（突袭）、黄月英（集智/奇才）、华佗（青囊/急救）、孙权（制衡/救援）、周瑜（英姿/反间）、貂蝉（闭月）、张飞（咆哮）、许褚（裸衣）、马超（马术/铁骑）、诸葛亮（空城/观星）、陆逊（谦逊/连营）、黄盖（苦肉）、孙尚香（结姻/枭姬）、吕布（无双）、大乔（流离）
...
- 主公技：孙权·救援已实现；曹操·护驾、刘备·激将待“向同势力借牌”请求
